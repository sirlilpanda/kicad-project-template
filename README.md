...
| ------------ | --- | --- |
| template | [✅](https://github.com/sirlilpanda/kicad-project-template/actions/runs/13539165272/attempts/1#summary-37836287197)| [✅](https://github.com/sirlilpanda/kicad-project-template/actions/runs/13539165272/attempts/1#summary-37836286256) | 
| test | [✅](https://github.com/sirlilpanda/kicad-project-template/actions/runs/13539165272/attempts/1#summary-37836287511)| [✅](https://github.com/sirlilpanda/kicad-project-template/actions/runs/13539165272/attempts/1#summary-37836286893) | 
...
This workflow will also run the design rules check on the PCB and schematic to ensure that you upload a working PCB. These reports are uploaded as summaries within the github [actions tab](https://github.com/sirlilpanda/kicad-project-template/actions/runs/13539165272). This template has a simple schematic PCB in it (because DRC fails on an empty PCB). Shown below is the example PCB.
